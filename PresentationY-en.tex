...
\setbeamertemplate{frametitle}{%
  ...
  \begin{beamercolorbox}[wd=\paperwidth,ht=4ex,dp=1ex]{frametitle}
    ...
    top=0pt,bottom=0pt,colframe=green!10!black,colback=green!10,boxrule=0.8pt]{
    \color{darkred}\insertframetitle}
  \end{beamercolorbox}%
}
...
\newenvironment{solution}{\par{\sffamily\color{structure.fg}Solution.}%
\enspace\ignorespaces}{\par}
