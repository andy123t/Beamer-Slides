...
%---------- 设置字体  ----------
\setbeamerfont{normal text}{family=\sffamily\songti}
...
\setbeamerfont{subsection in toc}{family=\sffamily\heiti}
\setbeamerfont{block title}{family=\sffamily\heiti}
\setbeamerfont{block title alert}{family=\sffamily\heiti}
\setbeamerfont{block title example}{family=\sffamily\heiti}
